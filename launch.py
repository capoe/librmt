            ...
            for i in range(i0_rep, options_meta["n_reps"]):
                ...
                if do_hyper:
                    ...
                    if len(options_hyper_set) > 1:
                        ...
                        log << "[hyper] Not running hyper-optimization as parameter grid consists of single point" << log.endl
                        idx = 0
                        model_hyper = "<single-point>"
                ...
                for key in log_state_keys:
                    if key in state_clone:
